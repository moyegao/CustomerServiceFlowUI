<style>
	...
	div.ztree_content_wrap div{width: 100%;}
	...
	.expendIcon {
	    ...
	    background-image: url("../../../static/imgs/ztree/zTreeStandard.png");
	}
	ul.ztree {background: #ffffff;height:auto;overflow-x:auto;overflow-y:scroll;}
	.ztree * {padding:0; margin:0;  font-family: Verdana, Arial, Helvetica, AppleGothic, sans-serif}
	.ztree {margin:0; padding:5px; color:#333 ;line-height: 19px}
	.ztree li{position: relative; padding:0; margin:0; list-style:none;text-align:left; white-space:nowrap; outline:0}
	.ztree li ul{ margin:0; padding:0 0 0 18px}
	.ztree li ul.line{ background:url('../../../static/imgs/ztree/line_conn.gif') 0 0 repeat-y;}
	.ztree li a {padding:1px 3px 0 5px; margin:0; cursor:pointer; color:#333; background-color: transparent;
		text-decoration:none; vertical-align:top; display: inline-block;font-size:12px!important;}
	.ztree li a:hover {text-decoration:underline;}
	.ztree li a.curSelectedNode {padding-top:0px; background-color:#c0d2ec; color:#fff; height:20px;}
	...
	.ztree li span.button {line-height:0; margin:0; width:16px; height:16px; display: inline-block; vertical-align:middle;
		...
		background-image:url("../../../static/imgs/ztree/zTreeStandard.png"); *background-image:url("../../../static/imgs/ztree/zTreeStandard.gif")
		}
	...
	span.tmpzTreeMove_arrow {width:16px; height:16px; display: inline-block; padding:0; margin:2px 0 0 1px; border:0 none; position:absolute;
		...
		background-position:-110px -80px; background-image:url("../../../static/imgs/ztree/zTreeStandard.png"); *background-image:url("../../../static/imgs/ztree/zTreeStandard.gif")
		}
