  ...
  <div class="taskcheckout">
    ...
    <div class="tableBox" style="margin-top:.15rem;">
      <el-table stripe v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" :data="tableData" height="99%" style="width: 100%">
        ...
        <el-table-column prop="preReportInfo" label="上月汇报详情" width="130" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="leaderOpinion1" label="分管领导意见" width="130" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="leaderOpinion2" label="公司领导意见" width="130" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="endDate" label="计划结束时间" width="130" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="planDesc" label="工作计划" width="130" show-overflow-tooltip>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      // };
      this.$common.commitParam(this, "/supervise/reportform/monthReport.api?supervisionTaskType=JT", params, {
    ...
    checkout() {
      ...
      params = params + "&supervisionTaskType=" + 'JT';
      // console.log(params);
